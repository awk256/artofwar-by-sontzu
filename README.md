...
これまで私の仕事は、「人間の意思決定を支援するためのデータ作り」でした。しかし、これからの仕事は、AIによる「人間の意思決定のプロセスそのものに深く関与する」時代へと移りつつあります。

AGI（汎用人工知能）がもたらすかも知れない人類存続の危機といった壮大な議論はさておき、現実の問題として、自分が「人間の仕事を奪うようなシステム」の設計者として召喚される可能性は十分にあります。もちろん、一方で非常に有意義で創造的な仕事に携わる可能性もあるでしょう。いずれにせよ、AIエージェントのクリエイターであれば誰もが、これまでとは全く異なる次元の問いを突きつけられる日が来ることを、私は直観しています。

果たして自分は、いかならシチュエーションの下でも、この未知なる知性を、人間と共生可能で持続的なシステムへと再定義できるだろうか。その問いに対し、正直に言えば、今の自分にその備えはありません。

個人としても、社会に対しても、致命的な失敗を犯さず、この革命的な恩恵を享受できるシステムへと翻訳していくために、私はエンジニアとしての生存戦略として、いつでも立ち返ることのできるノートを作成することにしました。

その指針を求めた先が、古代中国の戦略書『孫子の兵法』です。特に冒頭「始計篇」に記された五事（道・天・地・将・法）を、現代の意思決定における4W1H（Why・When・Where・Who・How）へとマッピングすることで、AI活用における戦略的判断の知恵が、強力な枠組みとして得られると考えたからです。

<img src="images/ArtofWarbySunTzu.png" width="300" alt="図解Strandsエージェント徹底解説">

本書では、以下の三章構成で論を展開します。
...
これは私が致命的な失敗を避けるための個人的な指針書であり、公開後も適宜更新し続ける「生きたノート」です。もし同じ立場にある方々にとって、本書が何らかの参考になれば、それはそれで素直に嬉しく思います。

ただ、掲載内容には筆者の主観による要約や再構成が含まれています。ご利用にあたっては、ご自身の判断と責任においてお願いいたします。
...
- [030-034.【欠番】五事で解く現場向け説明トークスクリプト](030.孫子の五事を使い切るAI実装ガイド/030-034.【欠番】五事で解く現場向け説明トークスクリプト.md)
