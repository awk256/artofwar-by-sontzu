...
これまで私の仕事は、「人間の意思決定を支援するためのデータ作り」を行うシステムを構築することでした。しかし、これからの仕事は、AIが「人間の意思決定のプロセスそのものに深く関与する」時代へと移りつつあります。
...
果たして自分は、この未知なる知性を、人間と共生可能で持続的なシステムへと再定義できるだろうか。その問いに対し、今の自分はあまりに無防備であることに気づかされました。
